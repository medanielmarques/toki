...
const navigationMenuTriggerStyle = cva(
  'inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none disabled:opacity-50 dark:focus:bg-slate-800 disabled:pointer-events-none bg-transparent dark:hover:bg-slate-800 dark:text-slate-100 dark:hover:text-slate-100 dark:data-[state=open]:bg-slate-800 dark:data-[active]:bg-slate-800 h-10 py-2 px-4 group w-max',
)
